...
Short Desc: GUI program that displays a manicure gallery part 1
"""
...
class ManiGallery(EasyFrame):
    ...
    def __init__(self):
        ...
        textLabel = self.addLabel(text = "Mani with Embellishments \nby Kevin L.", row = 1, column = 0, sticky = "NSEW")
        
        #loads the image and the label
        self.image = PhotoImage(file = "embellishMani.gif")
